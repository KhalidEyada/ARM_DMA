...
#define SET_BIT(REG,BitNo)              (REG |= (1u<<BitNo)) /*function like macro used to set a specific bit*/
#define CLR_BIT(REG,BitNo)              (REG &= ~(1u<<BitNo))/*function like macro used to clear a specific bit*/
#define ASS_BIT(REG,BitNo,VAL)          ((VAL==0)? CLR_BIT(REG,BitNo) : SET_BIT(REG,BitNo))/*function like macro used to assert a specific bit*/
#define TOG_BIT(REG,BitNo)              (REG ^= (1u<<BitNo))/*function like macro used to toggle a specific bit*/
...
#define SET_PORT(REG)					(REG |= (0xFF)) /*function like macro used to set a register*/
